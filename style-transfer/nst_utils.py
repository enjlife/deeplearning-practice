...
class CONFIG:
    ...
    VGG_MODEL = "/Users/enjlife/deep-learning-model/imagenet-vgg-verydeep-19.mat"
    VGG_MODEL_COLAB = 'imagenet-vgg-verydeep-19.mat'
...
def reshape_and_normalize_image(image):
    image = np.reshape(image, ((1,) + image.shape))  # shape image to (1,image.shape)
