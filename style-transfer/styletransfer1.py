...
def vgg_params():
    ...
    if _vgg_params is None:
        _vgg_params = sio.loadmat('/Users/enjlife/deep-learning-model/imagenet-vgg-verydeep-19.mat')
    return _vgg_params
...
if __name__ == '__main__':
    style = Image.open('style_images/style5.jpg')
    style = np.array(style).astype(np.float32) - 128.0
    content = Image.open('content_images/content3.jpg')
